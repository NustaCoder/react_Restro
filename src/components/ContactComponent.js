...
import { Breadcrumb, BreadcrumbItem, Col, Label, Row, Button } from 'reactstrap';
...
const numLength = (len) => (val) => !(val) || val.length === len;
      ...
      <div className="container">
        ...
        <div className="row row-content">
          ...
          <div className="col-12 col-md-9">
            <LocalForm model="feedback" onSubmit={(values) => this.handleSubmit(values, postFeedback)}>
              ...
              <Row className="form-group">
                ...
                <Col md={10}>
                  <Control.text model=".telnum" id="telnum" name="telnum"
                    ...
                    className="form-control"
                    validators={{
                      required, numLength: numLength(10), isNumber
                    }}
                  />
                  <Errors className="text-danger"
                    model=".telnum"
